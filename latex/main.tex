...
\PlagiarismChecker{Овчинников С.А.}
...
\ThesisConsultants{
Консультантов по работе нет
}

% Дата выдачи задания
\DateAssignment{<<18>> декабря 2025\,г.}

% Дата утверждения задания (должна быть не раньше даты выдачи задания)
\DateApproval{<<18>> декабря 2025\,г.}

% Для антиплагиата
% \renewcommand{\MakeThesisTitlePage}{}

\begin{document}

% \begin{center}
% \textbf{Тема:} Оценка стоимости ремонтных работ в автосервисе с применением методов машинного обучения \\[1em]
% \textbf{Автор:} Бутаков Богдан Игоревич \\[1em]
% \textbf{Научный руководитель:} Агабубаев Аслан Такабудинович
% \end{center}
% \newpage
...
% Разделы ВКР
\include{sections/1_nti}
\include{sections/2_struct_analysis}
% \include{sections/3_tech_analysis}
\include{sections/4_task}
\include{sections/5_architect_technical_solution}
\include{sections/6_math}
\include{sections/7_algorithm}
\include{sections/8_program_impl}
\include{sections/9_results}
